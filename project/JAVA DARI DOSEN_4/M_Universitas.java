...
public class M_Universitas extends MatKul {
	
	private String kode_khusus = "DUH";

	public M_Universitas(String kode, String kode_khusus, String nama, int sks, Nilai nilai) {
		super((kode + kode_khusus), nama, sks, nilai);
	}

	public M_Universitas() {
	}
